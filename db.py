...
client = MongoClient("mongodb+srv://avaneesh:test@cluster0.p5sdl.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
...
def save_user(username, email, password, is_admin_user=False):
    password_hash = generate_password_hash(password)
    users_collection.insert_one({'_id': username, 'email': email, 'password': password_hash, 'is_Admin': is_admin_user})
